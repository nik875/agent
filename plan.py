...
class PlanningModule:
    def __init__(self, api_key):
        ...
        self.agent.create_agent("Generate thorough, step-by-step, bite-sized plans to accomplish high-level goals and provide constructive criticisms of those plans.")
    ...
    def revise_plan(self, feedback):
        ...
        revised_plan = self.agent.prompt_agent(prompt)
        print(revised_plan)
